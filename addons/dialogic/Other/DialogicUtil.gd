...
static func get_next_translation_id() -> String:
	ProjectSettings.set_setting('dialogic/position/id_counter', ProjectSettings.get_setting('dialogic/position/id_counter', 16)+1)
	return '%x' % ProjectSettings.get_setting('dialogic/position/id_counter', 16)
