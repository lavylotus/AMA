...
func add_icon_button(icon:Texture2D, tooltip:String, editor:DialogicEditor=null) -> Node:
...
func add_custom_button(label:String, icon:Texture2D, editor:DialogicEditor) -> Node:
