...
@onready var broken_manager := get_node("Manager/TabBar/BrokenReferences")
...
func _ready() -> void:
	...
	icon_button = editors_manager.add_icon_button(get_theme_icon("Unlinked", "EditorIcons"), 'RefCounted Manager')
